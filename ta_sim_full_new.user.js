        ...
        qx.Class.define("TASuite.main", {
          ...
          members: {
            ...
            initialize: function () {
              ...
              this.add_ArmyChanged = (new qx.ui.core.EventHandler).$ctor(this, this.onUnitMoved);
            ...
            setupBattleground: function (offense_units) {
              try {
                ...
                var cityUnitsData = own_city.get_CityUnitsData();
            ...
            startSimulation: function () {
              try {
                ...
                battleground.m_Simulation.add_DamageDone$0((new qx.ui.core.EventHandler).$ctor(this, this.onDamageDone));
                battleground.m_Simulation.add_OnDestroyDefense$0((new qx.ui.core.EventHandler).$ctor(this, this.onDefenseDestroyed));
